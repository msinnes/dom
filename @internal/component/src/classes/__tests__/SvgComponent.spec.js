...
describe('SvgComponent', () => {
  it('should be a class', () => {
    expect(SvgComponent).toBeAClass();
  });

  it('should extend BaseElementComponent', () => {
    expect(SvgComponent).toExtend(BaseElementComponent);
  });
  ...
  describe('instance', () => {
    ...
    beforeEach(() => {
      ...
      instance = new SvgComponent('div', props);
    ...
    it('should have an elem prop', () => {
      expect(instance.elem).toBeInstanceOf(SvgNode);
